...
"""
    Initialize(input_data::AbstractModel.InputData)
...
# Arguments
- `input_data::AbstractModel.InputData`: Dictionary containing data used to build the model. 
...
```
"""
function Initialize(input_data::AbstractModel.InputData)
...
"""
function write_bid_matrix(model_contents::OrderedDict, input_data::AbstractModel.InputData)
