                    ...
                    for scenario in sscens
                        if is_balance_prices
                            ...
                            if isempty(temps)
                                ...
                                timeseries_data["scenarios"][scenario][k][series_direction][!, series] = filter(:t => x -> string(ZonedDateTime(DateTime(x), tz"UTC")) in temps, sub_df)[!, n]
                            end
                        else
                            if !(scenario in keys(timeseries_data["scenarios"]))
                                timeseries_data["scenarios"][scenario] = OrderedDict()
                            ...
                            if isempty(temps)
                                ...
                                timeseries_data["scenarios"][scenario][k][!, series] = filter(:t => x -> string(ZonedDateTime(DateTime(x), tz"UTC")) in temps, sub_df)[!, n]
                            end
                        end
                    end
                end
